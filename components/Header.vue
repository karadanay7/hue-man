<template>
  ...
  >
    ...
    <div
      v-if="isMenuOpen"
      class="flex flex-col lg:hidden top-16 absolute z-10 mx-auto left-0 right-0 border text-start border-gray-300 dark:border-gray-600 justify-center py-2 items-center bg-[#FFF5F1] dark:bg-emerald-950"
    >
    ...
    <div class="flex items-center justify-end gap-1.5 lg:flex-1">
      ...
      <ULink
        class="hidden lg:flex w-24 items-center justify-center gap-1 text-sm hover:text-primary"
        v-else
        @click="signOut()"
        size="xs"
      >
